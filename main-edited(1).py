    ...
    if not on_hit_final:
        ...
        if total_H >= 70:
            ...
            if total_Si >= 30:
                ...
                if total_Fe > total_Si & total_C <= 20:
            ...
            varFinal.set('None of the planets in our system is similar to yours, you are on a new way!')
    else:
        on_hit_final = False
        varFinal.set('')
